...
const fixtures = [
  ...
  },
  {
    ...
    diagnostics: [
      ...
      "proxy.ts: proxy decides from facts web holds itself; it cannot reach the backend, the session or runtime configuration (via test/guardrails/fixtures/architecture/proxy-dependencies/feature-flag.ts)",
    ],
  },
  {
