...
Режим: **Operate**. Автор открывает руководство из общего списка и редактирует название,
описание, обложку и состав на отдельной странице. Поведенческий контракт —
[Редактор руководства](../../../../docs/specifications/platform-v1.md#редактор-руководства).
...
Production-owned editor и список представлены в Storybook: `Pages/Authoring/Редактор руководства`.
