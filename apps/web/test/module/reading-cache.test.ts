...
it("removes query AND mutation data on Account changes and sign-out without touching public data", () => {
  ...
  client.setQueryData(["reading-progress", "first", "material", "72000000-0000-4000-8000-000000000020"], [{ isRead: true }]);
  client.setQueryData(["reading-progress", "second", "material", "72000000-0000-4000-8000-000000000020"], [{ isRead: false }]);
  ...
  expect(client.getQueryData(["reading-progress", "first", "material", "72000000-0000-4000-8000-000000000020"])).toBeUndefined();
  expect(client.getQueryData(["reading-progress", "second", "material", "72000000-0000-4000-8000-000000000020"])).toEqual([{ isRead: false }]);
