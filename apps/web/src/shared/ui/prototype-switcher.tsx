...
export const cardVariants = [
  { key: "A", name: "Подпись в карточке" },
  { key: "B", name: "Номер внутри карточки" },
  { key: "C", name: "Компактная лента" },
] as const;
...
export function PrototypeSwitcher() {
  ...
  return (
    <aside aria-label="Сравнение вариантов карточек" className="fixed bottom-24 left-1/2 z-50 w-[min(24rem,calc(100vw-2rem))] -translate-x-1/2 rounded-2xl border border-white/20 bg-primary p-3 text-white shadow-xl md:bottom-6">
