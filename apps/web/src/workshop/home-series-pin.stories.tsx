...
const meta = {
  ...
  args: { seriesId, controls: { pin: { seriesId: null, version: 2 }, pending: false, onChange }, message: "Закрепите этот практикум: оно появится первым на главной с изображением автора." },
  tags: ["autodocs"],
...
export const Selected: Story = { args: { controls: { pin: { seriesId, version: 3 }, pending: false, onChange }, message: "Практикум закреплён на главной." }, play: async ({ canvasElement }) => {
...
export const Conflict: Story = { args: { hasError: true, onRetry: fn(), message: "Закреп изменился в другой вкладке. Состояние обновлено; закрепите практикум ещё раз." } };
