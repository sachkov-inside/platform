...
const meta = {
  ...
  args: { seriesId, controls: { pin: { seriesId: null, version: 2 }, pending: false, onChange }, message: "Закрепите эту серию: она появится первой на главной с изображением автора." },
...
export const Selected: Story = { args: { controls: { pin: { seriesId, version: 3 }, pending: false, onChange }, message: "Серия закреплена на главной." }, play: async ({ canvasElement }) => {
...
export const Conflict: Story = { args: { hasError: true, onRetry: fn(), message: "Закреп изменился в другой вкладке. Состояние обновлено; закрепите серию ещё раз." } };
