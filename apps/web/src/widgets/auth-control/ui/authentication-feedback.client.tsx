...
export function AuthenticationFeedback() {
  ...
  return (
    <div
      className="fixed right-5 bottom-[max(1.25rem,env(safe-area-inset-bottom))] z-50 flex w-[calc(100%-2.5rem)] max-w-md items-start gap-3 rounded-2xl border border-destructive/25 bg-background px-5 py-4 text-sm leading-6 text-destructive shadow-lg"
      role="status"
    >
