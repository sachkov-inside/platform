...
interface MaterialRevisionPreviewProps {
  readonly preview: MaterialPreviewPresentation;
}

/** Exact-revision reading surface shared by Storybook and future production adapters. */
export function MaterialRevisionPreview({ preview }: MaterialRevisionPreviewProps) {
  return (
