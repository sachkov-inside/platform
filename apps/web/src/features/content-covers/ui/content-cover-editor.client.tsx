    ...
    >
      ...
      {ownerKind === "material" ? (
        <>
          ...
          <p className="mt-3 text-xs leading-5 text-muted-foreground">
            Рекомендуем обложку 16:9. В квадратном превью показывается центр
            изображения.
          </p>
        </>
      ) : null}
      <div
        className={cn(
          ...
          ownerKind !== "material" && "grid-cols-[6rem_minmax(0,1fr)]",
        )}
      >
        {ownerKind === "material" ? null : (
          <ContentCoverImage
            alt=""
            className="aspect-video rounded-lg"
            cover={cover}
