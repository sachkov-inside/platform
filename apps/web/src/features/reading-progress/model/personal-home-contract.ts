  ...
  z
    .object({
      ...
      continuation: z
        .object({
          video: z
            .object({ material: materialPreviewSchema, label: z.string() })
            .strict()
            .optional(),
          series: z
            .object({
              collection: z
                .object({
                  ...
                  previewItems: z.array(materialPreviewSchema).max(3),
                })
                .strict(),
...
export const personalHomeQueryKey = (accountId: string | null) =>
  ["reading-progress", accountId, "continue"] as const;
