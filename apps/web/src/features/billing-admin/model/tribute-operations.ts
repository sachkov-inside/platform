...
export const tributeStatusInputSchema = z.strictObject({
  operationId: z.uuid(),
  page: z.int().min(0).max(100000).optional(),
});
export const tributeStatusOutcomeSchema = z.object({
  operationRef: z.uuid(),
  result: z.object({
...
export const tributeSavePolicyOutcomeSchema = z.object({
  operationRef: z.uuid(),
  result: z.object({
...
export const tributePreviewOutcomeSchema = z.object({
  operationRef: z.uuid(),
  result: z.object({
...
export const tributeApplyOutcomeSchema = z.object({
  operationRef: z.uuid(),
  result: z.object({
...
export const tributeReconcileOutcomeSchema = z.object({
  operationRef: z.uuid(),
  result: z.object({
...
export const tributeRetryEventOutcomeSchema = z.object({
  operationRef: z.uuid(),
  result: z.object({
...
export const tributeDismissImportOutcomeSchema = z.object({
  operationRef: z.uuid(),
  result: z.object({
