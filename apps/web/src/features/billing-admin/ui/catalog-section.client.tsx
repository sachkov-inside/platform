...
export function CatalogSection({
  ...
  return (
    <>
      <AdminSection
        description="Варианты каталога с редакциями. Выключенный вариант не виден покупателю и не покупается, но остаётся здесь: включить его можно без новой редакции. Архивные позиции не перечисляются."
