...
/**
 * Каталог без руководств: между поиском и материалами ничего не стоит, поэтому здесь видно то же
 * начало первого экрана, что и в состоянии загрузки. Рукописная копия каркаса роняет проверку.
 */
