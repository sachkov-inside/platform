...
export const LongSeries: Story = { args: { result: { kind: "ready", value: { ...home, playlists: home.playlists.map((series) => ({ ...series, name: "Проектируем и развиваем приложение: от первой идеи до надёжного релиза с искусственным интеллектом", summary: null })) } } } };
