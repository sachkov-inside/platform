...
/** Урок глазами гостя из общего кеша: запрос идёт без токена, ключ записи — slug (ADR 0026). */
export async function readPublicMaterial(slug: string): Promise<PublicMaterialResult> {
  "use cache";
