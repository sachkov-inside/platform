...
export async function PersonalSeries({ result, accessToken, returnTarget }: {
  ...
  return <HydrationBoundary state={dehydrate(client)}><SavedSeries result={result} initialAccountId={accountId} {...(returnTarget === undefined ? {} : { returnTarget })} /></HydrationBoundary>;
}
