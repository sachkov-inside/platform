 ...
 */
export function AiFirstGuideView({
  result,
  page,
  returnTarget,
}: {
  ...
  return (
    <article
      ...
      data-guide-product={result.reference.slug}
...
function Hero({
  ...
  readonly block: GuidePageBlockOf<"hero">;
  readonly context: BlockContext;
}) {
  return (
    <header className="ai-guide-hero">
      <div className="ai-guide-hero-copy">
        ...
        {context.freeCount > 0 ? (
          <p className="ai-guide-format">
            Бесплатно: {formatMaterialCount(context.freeCount)}
          </p>
        ) : null}
      </div>
      <div className="ai-guide-artwork">
...
const outcomeVisuals: readonly ReactNode[] = [
  <div
    className="ai-guide-result-visual ai-guide-result-harness"
    aria-hidden="true"
    key="harness"
  >
    <FolderGit2 />
  ...
  <div
    className="ai-guide-result-visual ai-guide-result-pipeline"
    aria-hidden="true"
    key="pipeline"
  >
    <Workflow />
  ...
  <div
    className="ai-guide-result-visual ai-guide-result-project"
    aria-hidden="true"
    key="project"
  >
    <Server />
...
const bonusPreviews: readonly ReactNode[] = [
  <div
    className="ai-guide-bonus-preview ai-guide-bonus-video"
    aria-hidden="true"
    key="video"
  >
    <span>Идея</span>
  ...
  <div
    className="ai-guide-bonus-preview ai-guide-bonus-code"
    aria-hidden="true"
    key="code"
  >
    <FolderGit2 />
  ...
  <div
    className="ai-guide-bonus-preview ai-guide-bonus-questions"
    aria-hidden="true"
    key="questions"
  >
    <MessagesSquare />
