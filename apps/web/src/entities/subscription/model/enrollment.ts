...
export const enrollmentSchema = z.object({
  ...
  accountId: z.uuid(),
  tier: tierSchema,
  origin: z.enum(["course", "tribute", "manual", "platform_payment"]),
...
export const enrollmentSourceLabels = {
...
export const enrollmentStateLabels = {
  scheduled: "Начнётся позже",
  active: "Действует",
  expired: "Срок завершён",
  revoked: "Отозвано",
  pending_verification: "Ожидает проверки",
  suspended_source: "Основание приостановлено",
} as const;
