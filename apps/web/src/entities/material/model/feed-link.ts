...
export function feedLink(text: string, linkedHref?: string): { readonly href: string; readonly label: string } | undefined {
...
function parseFeedHref(href: string): { readonly href: string; readonly label: string } | undefined {
  try {
