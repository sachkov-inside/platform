...
const contentSecurityPolicy = [
  ...
  "object-src 'none'",
  "img-src 'self' data: blob: http://127.0.0.1:* https://storage.yandexcloud.net https://*.storage.yandexcloud.net https://kinescope.io https://*.kinescope.io https://*.kinescopecdn.net",
