...
- Публичный посетитель знакомится с главным руководством и читает общую ленту материалов.
...
Главная Platform выделяет одно авторское руководство и объединяет опубликованные материалы
в одну ленту с поиском и фильтрами формата. Отдельной Базы знаний нет. Руководство связывает видео,
текстовые гайды и заметки общей задачей; продолжение остальных занятий находится в профиле. Текущий scope и отношения сущностей определяет
