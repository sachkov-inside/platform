...
expectFailure(
  ...
  [
    ...
    "src/modules/example/features/swallow-failure/swallow-failure.ts:12: catch ignores error",
    "src/modules/example/features/swallow-failure/swallow-failure.ts:27: .catch swallows its failure",
  ],
);
