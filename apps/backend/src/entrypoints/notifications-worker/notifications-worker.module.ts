...
@Module({ imports: [PlatformConfigModule.forRoot(undefined, 'notifications-worker'), PrismaModule, RuntimeIdentityModule, NotificationsModule, ContentScopeCatalogModule, RecipientLinksModule], providers: [OperationalReadiness] })
