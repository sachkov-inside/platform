 ...
 */
export function replayCommandFingerprint(operation: string, command: unknown): ReplayFingerprint {
  return replayFingerprint({ version: 1, operation, command }, JSON.stringify(command));
}
