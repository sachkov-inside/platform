...
export const manageCatalogSchema = z.discriminatedUnion("operation", [
  z.strictObject({ ...envelope, operation: z.literal("offers.save"), value: offerSchema.omit({ revision: true, archived: true }) }),
...
export const catalogOutcomeSchema = z.strictObject({ id: idSchema, revision: revisionSchema, archived: z.boolean() });
