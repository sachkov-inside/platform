export const name = "0042_billing_notification_transport";
export const statement = `
CREATE TABLE billing.notification_outbox (
...
CREATE INDEX ON billing.notification_outbox(lane, published_at, next_attempt_at);
`;
