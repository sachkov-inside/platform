...
export const reorderSourceGuideBodySchema = z
...
export const validateSourceGuideBodySchema = z
  .object({
    sourceId,
  ...
  .strict();
export type ValidateSourceGuideOperation = (
  command: z.input<typeof validateSourceGuideBodySchema> & {
...
export type ReserveSourceGuideOperation = (
  command: z.infer<typeof reserveSourceGuideBodySchema> & {
    readonly actor: string;
  },
) => Promise<CreateContentCollectionResult>;

export type UpdateSourceGuideOperation = (
  command: z.infer<typeof updateSourceGuideBodySchema> & {
    readonly actor: string;
  },
) => Promise<UpdateContentCollectionResult>;
export type ReorderSourceGuideOperation = (
  command: z.input<typeof reorderSourceGuideBodySchema> & {
    readonly actor: string;
  },
