...
import { createDraftBodySchema, idempotencyKeySchema, materialRevisionSchema, parseMaterialAuthoringBody, throwMaterialAuthoringError } from "../../adapters/nest/material-authoring-http.js";
...
export class CreateDraftController {
  ...
  @Post()
  @ApiOperation({ operationId: "createMaterialDraft", summary: "Create a Material with its first draft revision" })
