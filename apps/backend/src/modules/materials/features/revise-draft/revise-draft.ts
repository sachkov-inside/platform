...
import { loadCurrentRevisionId } from "../../infrastructure/postgres/material-lookups.js";
...
export function assembleReviseDraft(
      ...
      (transaction, rollback) =>
        executeIdempotentRevision(
          ...
          async () => {
            ...
            const advanced = await transaction.material.updateMany({
              where: {
