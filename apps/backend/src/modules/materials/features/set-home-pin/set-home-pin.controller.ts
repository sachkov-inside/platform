...
export class SetHomePinController {
  ...
  @Put()
  @ApiOperation({
    operationId: "setAuthoringHomePin",
    summary: "Replace or remove the author's Home Series selection",
  })
  ...
  async set(
    ...
    const result = await this.authoring.setHomePin({
      actor: account.accountId,
      ...parseMaterialAuthoringBody(bodySchema, input),
    });
