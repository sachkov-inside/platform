...
export const videoUploadAttemptIdSchema = z
  .uuid()
  .brand<"VideoUploadAttemptId">();
export const videoDeletionOperationIdSchema = z
  .uuid()
  .brand<"VideoDeletionOperationId">();
export const videoWebhookInboxIdSchema = z
  .uuid()
  .brand<"VideoWebhookInboxId">();
export const videoIdempotencyKeySchema = z
  .string()
  .trim()
  .min(1)
  .max(128)
  .brand<"VideoIdempotencyKey">();
export const providerVideoIdSchema = z
  .string()
  .trim()
  .min(1)
  .max(256)
  .brand<"ProviderVideoId">();
...
export type VideoDeletionOperationId = z.output<
  typeof videoDeletionOperationIdSchema
>;
...
export function newVideoWebhookInboxId(): z.output<
  typeof videoWebhookInboxIdSchema
> {
