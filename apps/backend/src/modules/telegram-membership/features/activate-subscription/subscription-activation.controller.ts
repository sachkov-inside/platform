...
} from "../../domain/subscription-activation-wire.js";
import {
  Body,
  Controller,
  Headers,
...
export class SubscriptionActivationController {
  ...
  @HttpCode(200)
  @ApiOperation({
    operationId: "readSubscriptionActivationBinding",
    summary:
  ...
  @HttpCode(200)
  @ApiOperation({
    operationId: "readOwnSubscriptionAccess",
    summary:
  ...
  @HttpCode(200)
  @ApiOperation({
    operationId: "beginSubscriptionActivation",
    summary:
  ...
  @HttpCode(200)
  @ApiOperation({
    operationId: "acceptSubscriptionActivationEvidence",
    summary:
