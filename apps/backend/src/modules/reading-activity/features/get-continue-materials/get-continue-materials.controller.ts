...
export const continueMaterialSchema = z
  .object({
    material: publishedCatalogItemHttpSchema,
...
export class GetContinueMaterialsController {
  ...
  @Get()
  @ApiOperation({
    operationId: "getContinueMaterials",
    summary:
      "Read at most six accessible unfinished Materials of the current Account",
  })
  @ApiOkResponse({
    schema: toOpenApiSchema(z.array(continueMaterialSchema).max(6)),
  })
  @ApiResponse({
    status: 400,
