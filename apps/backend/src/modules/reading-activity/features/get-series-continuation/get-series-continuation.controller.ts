...
export const seriesContinuationHttpSchema = z
  .object({
    collection: publishedCatalogFacetHttpSchema,
    read: z.number().int().nonnegative(),
    total: z.number().int().nonnegative(),
    continuation: z
      .object({
        materialSlug: z.string(),
        resume: continueMaterialSchema.shape.resume,
      })
      .strict()
      .nullable(),
  })
...
export class GetSeriesContinuationController {
  ...
  @ApiOperation({
    operationId: "getSeriesContinuation",
    deprecated: true,
    summary:
