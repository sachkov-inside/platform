...
import { accountId, bootstrapOwnerAccount } from "../modules/accounts/index.js";
...
async function main(): Promise<void> {
  ...
  const subject = requiredValue("OWNER_LOGTO_SUBJECT");
...
function requiredValue(name: "OWNER_LOGTO_ISSUER" | "OWNER_LOGTO_SUBJECT"): string {
