...
beforeAll(async () => {
  ...
  expect(await migrateToLatest(database.url)).toEqual({ appliedMigrations: ["0038_home_material_pin", "0039_home_series_pin", "0046_scoped_access", "0047_subscription_payments", "0048_subscription_lifecycle", "0050_guide_artifacts", "0051_guide_chapters", "0052_bookmarks", "0053_community_entitlements", "0054_billing_manage_permission", "0055_billing_operations", "0056_billing_notices", "0057_guide_introduction", "0058_offer_for_sale", "0059_one_time_purchase", "0060_material_announcements", "0061_lesson_difficulty_and_outcomes", "0062_reader_guide_mode", "0063_subscription_enrollments", "0064_tribute_sources", "0067_legal_acceptances", "0065_video_detachment", "0069_guide_material_removals", "0066_refund_basis", "0068_starter_tier_access", "0065_authoring_source", "0070_guide_page"] });
