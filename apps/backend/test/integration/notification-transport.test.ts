 ...
 * воркер не подписывался, укладывается в 0.4–0.6 с). Бюджет взят с восьмикратным запасом к худшему
 * измеренному. Честная граница этого числа: под нагрузкой раннера реакция брокера не измерялась.
 */
const brokerReapBudgetMs = 30_000;
/**
 ...
 */
const crashScenarioTimeoutMs = crashWorkerStartBudgetMs + brokerReapBudgetMs + barrierBudgetMs * 4 + 5_000;
