...
|---|---|---|---|---|---|---|---|
| Карта | пройдена дважды | не доставлено банком; подтверждено сверкой | выдано | пройден дважды | проверяет владелец | проверяет владелец | см. ниже |
...
- Чеки продажи и возврата видны только в кабинете кассы; их сверяет владелец.
