...
[Mailpit](http://127.0.0.1:3625). Telegram-кнопка ведёт на экран с предупреждениями и числом
подтверждения. В синтетическом режиме ссылка на бота не завершит вход через настоящий Telegram.
