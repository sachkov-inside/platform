...
«Подтвердить вход» / «Отменить»; после подтверждения исходная вкладка автоматически завершает вход. В синтетическом режиме ссылка на бота не завершит вход через настоящий Telegram.
