...
полному графу. Новое ребро, которое замыкает цикл, разворачивается через port потребителя или
переносом общего значения ниже по графу.
...
- Content Access сам описывает нужные ему решения о членстве и доступе Workshop, Workshop — решение
  о членстве под блокировкой выдачи. Materials и Billing сами описывают ответ источника
  уведомления. Реализации подходят к этим port структурно.
