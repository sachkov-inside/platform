...
does not run on every pull request. Pull requests into `main` run the five-job application, Docker
Compose and production-foundation gate on clean GitHub-hosted runners; see
