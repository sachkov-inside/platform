...
материалах идут только тем, кто сам включил канал в разделе «Уведомления». Проверка обоих
подключённых producer/provider приложений, реальные внешние отправки и production-разрешения
принадлежат #438.
