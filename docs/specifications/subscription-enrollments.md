...
- Tribute открывает тариф только через реестр источника (политика, preview/apply, сверка):
  владельческое `enrollments.assign` с `origin: tribute` не является рабочим путём.
