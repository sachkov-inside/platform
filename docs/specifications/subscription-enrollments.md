...
- `support` в предложении продукта (с правом `guide:*`) всегда имеет конечный срок в
  `benefitPeriods`; без него каталог не сохраняет и не публикует предложение, а расчёт не продаёт
  прежнюю строку. Решение владельца — шесть месяцев с покупки.
