...
выдаче обещает подписку даже при выключенной продаже. Вывести его из каталога значит читать
каталог на каждый запрос ради мета-тега, поэтому решение отложено к #506, который занимается
предпросмотром ссылок и индексацией.
