...
явным recurring consent; завершённая подписка требует новой покупки. Расписание без пригодной
...
на итоге. Оплаченные 1 000 ₽ и переход на 3 500 ₽ ровно в середине месяца дают 1 250 ₽. Понижение и
другая длительность вступают в силу следующим периодом, и запланированное изменение снимается до
соответствующей отправленной попытки. Нулевая или отрицательная доплата не отправляется в банк.
