...
billing/offers` возвращает пустой список, блок на главной, приглашение к тарифам в программе
руководства и раздел подписки в кабинете не показываются. Архивация сохраняет прежний смысл окончательного снятия;
