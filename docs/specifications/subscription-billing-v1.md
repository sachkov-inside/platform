...
billing/offers` возвращает пустой список, блок на главной, CTA на странице руководства и раздел
подписки в кабинете не показываются. Архивация сохраняет прежний смысл окончательного снятия;
