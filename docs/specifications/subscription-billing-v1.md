...
закрывает #509. Архивация сохраняет прежний смысл окончательного снятия;
признак продажи при архивации не используется.
...
забирает участие, а снятие последнего — забирает. Возврат покупки руководства с решением владельца
«отозвать доступ» отзывает её оплаченное право и вместе с ним участие, если другого основания нет.
