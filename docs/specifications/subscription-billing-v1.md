...
универсальный прокси браузера. Архивные позиции каталога здесь не перечисляются: у backend нет
операции их чтения, и страница показывает только действующие варианты.
...
Руководство продаётся, только когда у него есть действующий разовый вариант. Отсюда следует
«по умолчанию не продаётся ничего»: отдельный признак продажи не нужен, а витрина и кнопка покупки
появляются и исчезают вместе с предложением. Тумблеры вариантов подписки остаются за #493.
