...
смотри «Текущая поставка #507». Архивация сохраняет прежний смысл окончательного снятия;
...
Блок покупки на странице руководства появляется там, где читателю чего-то не хватает: предложение
разрешает продажу, но у кого руководство уже открыто, тому предлагать покупку нечего. Витрина
`/guides/<slug>/buy` при этом показывает цену по прямому адресу независимо от этого условия.
...
Незакрытой остаётся страница руководства, и таких мест там два: у руководства без своей цены блок
«Часть материалов открыта по подписке» ведёт к тарифам, а у руководства с ценой блок «Купите это
руководство» несёт вторую ссылку «Посмотреть подписку». Оба показываются независимо от состояния
продажи и появились до этой поставки. Блок переписывает #509, переносящий покупку в программу
руководства; требование там предложено, но владельцем ещё не принято.
...
Пока страница руководства и описание маршрута не закрыты, правило «при всех выключенных вариантах
ни одна страница не предлагает подписку» выполняется не полностью.
