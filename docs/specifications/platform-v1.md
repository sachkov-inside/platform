...
Общий список `/authoring/playlists` показывает обложку, название, число материалов, архивное
состояние и закреп каждой серии. Название открывает отдельную страницу
`/authoring/playlists/[seriesId]`; вложенного редактора в списке нет. Значок закрепа меняет
единственную серию на главной без открытия редактора; выбранная строка отмечена «На главной».
Архивную серию можно открыть для редактирования и снять её существующий закреп.

Страница серии объединяет редактирование названия, описания, обложки и упорядоченного состава.
Создание серии сразу открывает эту страницу. Название, описание и состав сохраняются
...
Настройка именованной последовательности шагов раскрывается у конкретного материала.
Возврат ко всем сериям дожидается сохранения изменений; ошибка не закрывает редактор.
Архивирование и восстановление остаются на странице серии.
