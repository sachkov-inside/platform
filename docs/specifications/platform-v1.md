...
ключевая мысль, изображение и файл. Новый блок — одна запись в реестре и один компонент внешнего
вида; приложения блоки не объявляют.
...
`abstract`; остальные совпадают по имени.
