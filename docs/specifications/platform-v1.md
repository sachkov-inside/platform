...
1. Пока у Account нет записи о принятии действующей редакции `terms`, callback и серверные
   ...
   условия и политику и кнопка «Принять условия и продолжить» с фокусом. Окно не закрывается без
   решения; отметок нет, подтверждённая почта не требуется. Новая редакция
