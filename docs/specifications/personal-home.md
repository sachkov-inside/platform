...
- В «Сериях» первой показывается последняя начатая незавершённая серия. В существующей плашке
  карточки — «Продолжить · изучено N из M». Карточка всегда открывает страницу серии. В маршруте
  выделяется материал для продолжения с подписью «Продолжить здесь» или сохранённым временем видео. Остальные серии идут следом без повтора.
