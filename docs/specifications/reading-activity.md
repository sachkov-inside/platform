...
- allRead = total>0 и read=total. Сводку «изучено N из M» показывает карточка руководства на
  персональной главной; на самой странице руководства её нет (решение владельца 12.09.2026).
  Процентов и оценки усвоения нет нигде.
