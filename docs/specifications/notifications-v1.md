...
- #438 (поставлено): оба источника доходят до обоих каналов и возвращают результаты на реальных
  ...
  Проверены оба продукта продажи, права библиотеки и отдельного руководства, отличие выдачи права
  от покупки, общий предел канала и очередь массовой рассылки. Разбор видов доказательства —
