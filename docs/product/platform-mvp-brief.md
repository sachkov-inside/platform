...
разово: у него появляется своя цена в том же каталоге оплаты, своя витрина и кнопка покупки на
странице руководства. Такая покупка не создаёт подписку, не требует согласия на списания и по
...
3. **Guide.** Руководство — самостоятельный продукт с упорядоченным составом материалов.
   ...
   Автор пишет для читателя четыре поля руководства: что он сможет, для кого руководство, что нужно
   знать заранее и что остаётся за границами. Ненаписанное поле не показывается, поэтому частично
   готовое руководство не выглядит завершённым; условия доступа и цены на страницу не выводятся.
