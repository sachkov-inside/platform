...
те руководства, которым владелец завёл цену. В #412 опубликован раздел `/legal`: восемь
документов действуют с 12.09.2026, у каждой редакции есть постоянный адрес и контрольная сумма,
а оформление показывает оферту своей покупки и согласие на автопродление только для подписки.
Приём денег этим не включается: сквозной прогон на тестовом терминале остаётся за #413, готовность
рабочего терминала — за #414, а продажа каждого предложения включается владельцем отдельно. Прежний outbound CTA на Platform-configured Tribute URL
