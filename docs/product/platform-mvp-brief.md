...
разово: у него появляется своя цена в том же каталоге оплаты, своя витрина, а цена и кнопка покупки
встречают читателя наверху программы руководства. Такая покупка не создаёт подписку, не требует согласия на списания и по
умолчанию открывает руководство бессрочно; продаются только те руководства, которым владелец завёл
цену. Приём денег ещё не включён — терминал и
...
3. **Guide.** Руководство — самостоятельный продукт с упорядоченным составом материалов.
   ...
   Руководство живёт двумя страницами. Страница продукта рассказывает: обложка, четыре авторских
   поля — что читатель сможет, для кого руководство, что нужно знать заранее и что остаётся за
   границами, — программа обзором по главам и артефакты как обещание результата. Ненаписанное поле
   не показывается, поэтому частично готовое руководство не выглядит завершённым; цены и покупки
   на странице продукта нет, а единственное действие ведёт в программу. Бесплатный вход из обложки
   открывает первый доступный материал.
   Страница программы показывает сами материалы: главы, порядок, состояния доступа и прогресс.
   Цену руководства читатель встречает здесь, рядом с бесплатными материалами и замками.
