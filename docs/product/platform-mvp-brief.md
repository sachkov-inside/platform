...
Платформа поставила собственные страницы оплаты в #411: витрина тарифов, оформление подписки и
платёжный кабинет живут в Platform и работают поверх её собственного billing. Пока терминал не
подключён и юридические страницы не опубликованы, оформление честно сообщает, что принять оплату
нельзя; production activation остаётся за #402/#412/#413/#414. Прежний outbound CTA на
Platform-configured Tribute URL сохраняется до отдельного решения о его снятии: Platform не читает
Tribute API/webhooks и не делает access decision по клику или неподтверждённому payment state. В #404 доступны внутренние операции ручного
