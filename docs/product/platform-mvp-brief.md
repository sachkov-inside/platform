...
- **Главная** — public entry point `/` и bounded mobile-first витрина из текущих published данных:
  ...
  CTA ведёт на внутреннюю витрину `/subscription`, а не на внешний адрес. При active/unknown
...
На desktop шапка содержит Главную, Базу знаний, Закладки, переход «Найти материал» в каталог и
...
навигация «Главная / База знаний / Закладки / Профиль» с иконками и равными зонами нажатия;
...
`aria-current`. Вход и действия аккаунта доступны через Профиль, поиск — в Базе знаний. Topic,
Guide и Reader сохраняют выбранной Базу знаний. Нижняя панель учитывает safe area; содержимое и
