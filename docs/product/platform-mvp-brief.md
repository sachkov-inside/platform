...
3. **Series.** Серия является упорядоченной последовательностью и в русском интерфейсе называется
   ...
   и текст продолжения: текущий материал выделен визуально. Формат, статус просмотра, доступ
   и последовательность шагов сохраняются. Нумерация шагов учитывает только опубликованный состав.
