...
- **Главная** — `/`: одно закреплённое автором руководство и общая лента всех опубликованных
  ...
  проверки → приложение» с остановкой и reduced motion. Название и действие видимы постоянно.
  ...
  Лента единообразно показывает автора, дату, название, текст и обложку при наличии. Короткая
  ...
  в ленте только обложка и известная длительность. Поиск и форматы «Все / Видео / Гайды / Заметки»
