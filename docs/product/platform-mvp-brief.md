...
3. **Series.** Серия является упорядоченной последовательностью и в русском интерфейсе называется
   ...
   серии. В общем списке у них видны одинаковое название и «Шаг n из m»; между ними остаются
   видео, заметки и любые другие материалы. Нумерация учитывает только опубликованный состав.
