...
доставки; Platform проверяет автора и предоставляет операции управления. Реализация фасада ещё не
означает готовность интерфейса или запуска на аудиторию: границы описаны в
