...
руководство; возврат покупки закрывает чат, если другого действующего основания нет (#524). Приём денег ещё не включён — терминал и
юридические страницы принимаются отдельно в #402/#412/#413/#414, — поэтому оформление прямо
сообщает, что принять оплату нельзя. Прежний outbound CTA на Platform-configured Tribute URL
