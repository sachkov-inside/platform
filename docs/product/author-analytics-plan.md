...
MembershipEntitlement подтверждает доступ, Telegram join подтверждает участие, нажатие на
предложение доступа — намерение купить. Ни одно из них не подтверждает оплату.
