...
где `Получить доступ` ведёт на Platform-configured Tribute URL: призыв к покупке ведёт на внутреннюю
витрину или страницу оплаты руководства, а внешнего адреса покупки и его настройки у Platform нет.
