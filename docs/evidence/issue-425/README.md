> Этот отчёт фиксирует проверку до перехода Series → Guide. Совместный результат #425/#448,
> актуальные названия, снимки и проверки — [интеграция руководств](../issue-448/integration/README.md).
