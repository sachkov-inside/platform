...
Архивирование теперь ждёт сохранения названия, описания и состава. Во время загрузки обложки
оно блокируется; после загрузки автор повторяет действие. При ошибке сохранения архивирование
не выполняется. Эта проверка использует
