...
const content = resolve(
  values.content ?? resolve(dirname(identity), "..", "inside-content"),
);
if (!existsSync(resolve(content, "tools/content.py")))
  throw new Error(`Inside Content is not at ${content}; pass --content PATH`);
