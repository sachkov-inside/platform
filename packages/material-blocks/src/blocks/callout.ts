...
const calloutToneSchema: z.ZodEnum<
  z.core.util.ToEnum<(typeof calloutTones)[number]>
> = z.enum(calloutTones);
...
export const calloutBlock: MaterialBlockDefinition =
  defineMaterialBlock<"callout">({
    ...nested,
    issues: (node, report) => {
    ...
    node: {
      ...
      renderHTML: (attributes) => [
        ...
        [
          "p",
          { "data-callout-name": "" },
          attributeText(attributes["data-callout-title"]),
        ],
